...
public:
    ...
    public:
        ...
        void setAttribute(std::string attr, std::string val) override {image.setAtrribute(attr,val);}
    ...
    public:
        ...
        void setAttribute(std::string attr, std::string val) override {circle.setAtrribute(attr,val);}
